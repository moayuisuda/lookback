...
5. 所有应用内的语言用英文
6. 使用中文进行总结回答
7. 开发阶段不要有任何旧数据兼容逻辑，开发阶段不要有任何旧数据兼容逻辑开发阶段不要有任何旧数据兼容逻辑开发阶段不要有任何旧数据兼容逻辑开发阶段不要有任何旧数据兼容逻辑开发阶段不要有任何旧数据兼容逻辑开发阶段不要有任何旧数据兼容逻辑开发阶段不要有任何旧数据兼容逻辑开发阶段不要有任何旧数据兼容逻辑开发阶段不要有任何旧数据兼容逻辑开发阶段不要有任何旧数据兼容逻辑
