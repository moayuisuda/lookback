export const zh = {
  ...
  "commandPalette.externalLoading": "加载中",
  ...
  "toast.openExternalFailed": "打开外部链接失败：{{error}}",
  "toast.shortcutInvalid": "快捷键无效",
  "toast.shortcutConflict": "快捷键已被占用",
  ...
  "error.commandImportDuplicate": '命令 "{{name}}" 已存在，请先删除后再导入。',
  ...
  "canvas.toolbar.pen": "手绘",
  "canvas.toolbar.penStrokeWidth": "笔触大小",
  "canvas.toolbar.penColor": "笔触颜色",
  "canvas.toolbar.penErase": "擦除笔画",
