export const zh = {
  ...
  "commandPalette.llmText": "文本录入",
  "commandPalette.llmTextCopy": "复制",
  "commandPalette.llmTextCopyLoading": "复制中…",
  "commandPalette.llmTextLoadFailed": "加载 llm.txt 失败：{{error}}",
  "commandPalette.llmTextStep1Prefix": "1. 复制提示词",
  "commandPalette.llmTextStep2": "2. 粘贴到任意 AI 对话，最后补上你的需求",
  "commandPalette.llmTextStep3": "3. 将 AI 对话返回的内容原样拷贝到下方",
  "commandPalette.llmTextInputPlaceholder":
    "将 AI 返回的完整命令源码粘贴到这里",
  "commandPalette.llmTextImport": "保存并导入",
  "commandPalette.llmTextImportLoading": "导入中…",
  ...
  "commandPalette.externalFile": "文件：{{name}}",
  "commandPalette.externalBroken": "错误",
  "commandPalette.externalBrokenHint": "加载失败：{{error}}",
  ...
  "titleBar.version.checkNow": "检查更新",
  "titleBar.version.checking": "正在检查更新…",
  "titleBar.version.checkHint": "可手动检查新版本",
  "titleBar.version.checkingButton": "检查中…",
  "titleBar.version.downloadNow": "下载更新",
  "titleBar.version.downloading": "正在下载更新 {{progress}}%",
  "titleBar.version.downloadingButton": "下载中 {{progress}}%",
  ...
  "toast.command.scriptFailedWithReason": "Command 脚本执行失败：{{error}}",
  ...
  "toast.llmTextCopied": "llm.txt 已复制",
  "toast.llmTextCopyFailed": "复制 llm.txt 失败：{{error}}",
  "toast.llmTextImported": "命令已导入：{{id}}",
  "toast.llmTextImportFailed": "文本导入失败：{{error}}",
